  ...
  pt: {
    translation: {
      ...
      prescribe: {
        ...
        subtitle: "Monte o treino que {client} vai seguir no app.",
        offline: "Prescrever requer conexão com o Supabase neste build.",
        nameLabel: "Nome do treino",
        namePlaceholder: "Ex.: Treino A - Superiores",
        whenLabel: "Quando",
        today: "Hoje",
        tomorrow: "Amanhã",
        noDate: "Sem data",
        ...
        reps: "Reps",
        weight: "Carga (kg)",
        emptyExercises: "Nenhum exercício adicionado ainda.",
        save: "Salvar treino",
        saving: "Salvando...",
        requiredName: "Informe o nome do treino.",
        requiredExercises: "Adicione pelo menos um exercício.",
        savedTitle: "Treino prescrito!",
        savedBody: "O aluno já pode ver o treino no app.",
        saveErrorTitle: "Não foi possível salvar",
      },
      prescription: {
        eyebrow: "Do seu personal",
        forToday: "Prescrito para hoje",
        nextUp: "Próximo treino",
        exercisesCount: "{count} exercícios",
        loading: "Carregando treino prescrito...",
        cta: "Começar treino",
      },
      adherence: {
        lastToday: "Treinou hoje",
        lastYesterday: "Treinou ontem",
        lastDaysAgo: "Treinou há {days} dias",
        noCheckins: "Sem treinos registrados",
        detailTitle: "Aderência",
        detailSubtitle: "Sessões prescritas concluídas por {client}.",
        offline: "Aderência requer conexão com o Supabase neste build.",
        weekSummary: "Últimos 7 dias",
        weekCount: "{count} treinos",
        weekVolume: "Volume {volume}",
        statSessions: "Treinos",
        statVolume: "Volume",
        sessionsTitle: "Sessões recentes",
        empty: "Nenhum treino concluído ainda.",
        loading: "Carregando aderência...",
        sets: "{count} séries",
        exercises: "{count} exercícios",
        clientFallback: "Aluno",
      },
      measurements: {
        title: "Minhas medidas",
        subtitle: "Envie suas medidas para o seu personal acompanhar sua evolução.",
        offline: "Enviar medidas requer conexão com o Supabase neste build.",
        noCoach: "Vincule-se a um personal para enviar medidas.",
        dateLabel: "Data",
        weight: "Peso (kg)",
        bodyFat: "Gordura (%)",
        chest: "Peito (cm)",
        ...
        calf: "Panturrilha (cm)",
        notes: "Observações",
        notesPlaceholder: "Como você se sentiu? Alguma observação?",
        save: "Enviar medidas",
        saving: "Enviando...",
        requiredField: "Informe pelo menos uma medida.",
        savedTitle: "Medidas enviadas!",
        savedBody: "Seu personal já pode ver os números.",
        saveErrorTitle: "Não foi possível enviar",
        historyTitle: "Histórico",
        emptyHistory: "Nenhuma medida enviada ainda.",
        loading: "Carregando medidas...",
        latestTitle: "Última avaliação",
        delta: "Desde a anterior",
        coachTitle: "Medidas",
        coachSubtitle: "Avaliações corporais enviadas por {client}.",
        coachEmpty: "O aluno ainda não enviou medidas.",
      },
    },
  },
  en: {
    translation: {
      ...
      prescribe: {
        ...
        subtitle: "Build the workout {client} will follow in the app.",
        offline: "Prescribing requires a Supabase connection in this build.",
        nameLabel: "Workout name",
        namePlaceholder: "e.g.: Workout A - Upper body",
        whenLabel: "When",
        today: "Today",
        tomorrow: "Tomorrow",
        noDate: "No date",
        ...
        reps: "Reps",
        weight: "Load (kg)",
        emptyExercises: "No exercise added yet.",
        save: "Save workout",
        saving: "Saving...",
        requiredName: "Enter the workout name.",
        requiredExercises: "Add at least one exercise.",
        savedTitle: "Workout prescribed!",
        savedBody: "The student can already see the workout in the app.",
        saveErrorTitle: "Could not save",
      },
      prescription: {
        eyebrow: "From your coach",
        forToday: "Prescribed for today",
        nextUp: "Next workout",
        exercisesCount: "{count} exercises",
        loading: "Loading prescribed workout...",
        cta: "Start workout",
      },
      adherence: {
        lastToday: "Trained today",
        lastYesterday: "Trained yesterday",
        lastDaysAgo: "Trained {days} days ago",
        noCheckins: "No workouts logged",
        detailTitle: "Adherence",
        detailSubtitle: "Prescribed sessions completed by {client}.",
        offline: "Adherence requires a Supabase connection in this build.",
        weekSummary: "Last 7 days",
        weekCount: "{count} workouts",
        weekVolume: "Volume {volume}",
        statSessions: "Workouts",
        statVolume: "Volume",
        sessionsTitle: "Recent sessions",
        empty: "No workout completed yet.",
        loading: "Loading adherence...",
        sets: "{count} sets",
        exercises: "{count} exercises",
        clientFallback: "Student",
      },
      measurements: {
        title: "My measurements",
        subtitle: "Send your measurements so your coach can track your progress.",
        offline: "Sending measurements requires a Supabase connection in this build.",
        noCoach: "Link to a coach to send measurements.",
        dateLabel: "Date",
        weight: "Weight (kg)",
        bodyFat: "Body fat (%)",
        chest: "Chest (cm)",
        ...
        calf: "Calf (cm)",
        notes: "Notes",
        notesPlaceholder: "How did you feel? Any notes?",
        save: "Send measurements",
        saving: "Sending...",
        requiredField: "Enter at least one measurement.",
        savedTitle: "Measurements sent!",
        savedBody: "Your coach can already see the numbers.",
        saveErrorTitle: "Could not send",
        historyTitle: "History",
        emptyHistory: "No measurements sent yet.",
        loading: "Loading measurements...",
        latestTitle: "Latest check",
        delta: "Since previous",
        coachTitle: "Measurements",
        coachSubtitle: "Body checks submitted by {client}.",
        coachEmpty: "The student has not sent measurements yet.",
      },
    },
  },
  es: {
    translation: {
      ...
      prescribe: {
        title: "Prescribir entrenamiento",
        subtitle: "Arma el entrenamiento que {client} seguirá en la app.",
        offline: "Prescribir requiere conexión con Supabase en este build.",
        nameLabel: "Nombre del entrenamiento",
        namePlaceholder: "Ej.: Entrenamiento A - Tren superior",
        whenLabel: "Cuándo",
        today: "Hoy",
        tomorrow: "Mañana",
        noDate: "Sin fecha",
        ...
        reps: "Reps",
        weight: "Carga (kg)",
        emptyExercises: "Aún no añadiste ejercicios.",
        save: "Guardar entrenamiento",
        saving: "Guardando...",
        requiredName: "Indica el nombre del entrenamiento.",
        requiredExercises: "Añade al menos un ejercicio.",
        savedTitle: "¡Entrenamiento prescrito!",
        savedBody: "El alumno ya puede ver el entrenamiento en la app.",
        saveErrorTitle: "No se pudo guardar",
      },
      prescription: {
        eyebrow: "De tu entrenador",
        forToday: "Prescrito para hoy",
        nextUp: "Próximo entrenamiento",
        exercisesCount: "{count} ejercicios",
        loading: "Cargando entrenamiento prescrito...",
        cta: "Empezar entrenamiento",
      },
      adherence: {
        lastToday: "Entrenó hoy",
        lastYesterday: "Entrenó ayer",
        lastDaysAgo: "Entrenó hace {days} días",
        noCheckins: "Sin entrenamientos registrados",
        detailTitle: "Adherencia",
        detailSubtitle: "Sesiones prescritas completadas por {client}.",
        offline: "La adherencia requiere conexión con Supabase en este build.",
        weekSummary: "Últimos 7 días",
        weekCount: "{count} entrenamientos",
        weekVolume: "Volumen {volume}",
        statSessions: "Entrenos",
        statVolume: "Volumen",
        sessionsTitle: "Sesiones recientes",
        empty: "Aún no hay entrenamientos completados.",
        loading: "Cargando adherencia...",
        sets: "{count} series",
        exercises: "{count} ejercicios",
        clientFallback: "Alumno",
      },
      measurements: {
        title: "Mis medidas",
        subtitle: "Envía tus medidas para que tu entrenador siga tu evolución.",
        offline: "Enviar medidas requiere conexión con Supabase en este build.",
        noCoach: "Vincúlate a un entrenador para enviar medidas.",
        dateLabel: "Fecha",
        weight: "Peso (kg)",
        bodyFat: "Grasa (%)",
        chest: "Pecho (cm)",
        ...
        calf: "Pantorrilla (cm)",
        notes: "Observaciones",
        notesPlaceholder: "¿Cómo te sentiste? ¿Alguna observación?",
        save: "Enviar medidas",
        saving: "Enviando...",
        requiredField: "Indica al menos una medida.",
        savedTitle: "¡Medidas enviadas!",
        savedBody: "Tu entrenador ya puede ver los números.",
        saveErrorTitle: "No se pudo enviar",
        historyTitle: "Historial",
        emptyHistory: "Aún no enviaste medidas.",
        loading: "Cargando medidas...",
        latestTitle: "Última evaluación",
        delta: "Desde la anterior",
        coachTitle: "Medidas",
        coachSubtitle: "Evaluaciones corporales enviadas por {client}.",
        coachEmpty: "El alumno aún no envió medidas.",
      },
    },
  },
} as const;
